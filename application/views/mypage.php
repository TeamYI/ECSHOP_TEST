        ...
        <div class="col-md-8">
          ...
          <h4>ユーザー情報</h4>
            <table class="table table-bordered table-hover">
                <tr class="info">
                  <td width="100px">アカウント</td>
                  <td><?= $user_info[0]->user_id ?></td>
                </tr>
                <tr>
                  <td width="100px">パスワード</td>
                  <td><input type="password" name="" value="<?= $user_info[0]->user_pw ?>"></td>
                </tr>
                <tr class="success">
                ...
                <tr>
                  <td width="100px">メール</td>
                  <td><?= $user_info[0]->user_email ?></td>
                </tr>
                <tr class="warning">
              ...
              <table class="table table-bordered table-hover">
                ...
                <?php foreach($order_info as $info_ls) : ?>
                  <?php if($main_ls->od_no == $info_ls->od_no){ ?>
                    <tr>
                      <td class="active" width="100px"><img style="min-height:50px; height:50px;" src="/ci<?= $info_ls->pd_img ?>"></td>
