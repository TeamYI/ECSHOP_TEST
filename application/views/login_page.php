    ...
    <div class="container-fluid">
      <div class="row">
       <!-- 3단길이의 첫번째 열 -->
        ...
        <div class="col-md-6">
          <!-- 로그인폼 --><!-- 로그인폼 -->
          <form id="login-form" action="/ECSHOP_TEST/index.php/Controller_EC/login" method="post">
            <br>
            <div>
              <input type="text" class="form-control" name="user_id" placeholder="UserID" autofocus>
            </div>
            <br>
            <div>
