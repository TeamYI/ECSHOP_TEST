...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<!-- 로그인폼 --><!-- 로그인폼 -->
			<form id="order_no" action="/ECSHOP_TEST/index.php/Controller_EC/check_order_info_by_order_no"
				  method="post">
				<h4>注文番号で照会</h4>
			...
			<?php if ($order_main != null) { ?>
					<table class="table table-striped table-bordered table-hover col-md-12">
						...
						<tr class="info">
							...
							<td colspan="3"><?= $order_main[0]->od_no ?></td>
						</tr>
						<tr class="success">
							<td colspan="1" width="100px">注文日時</td>
							<td colspan="3"><?= $order_main[0]->od_date ?></td>
						</tr>
						<tr class="warning">
							<td colspan="1" width="100px">配送先</td>
							<td colspan="3"><?= $order_main[0]->receiver_address ?></td>
						</tr>
						<th>商品名</th>
						<th>数量</th>
						<th>合計</th>
