...
//        ));
	...
	public function insert_order($order_info)
	{
		...
		$query = "insert into order_main (user_no,od_name,od_email,od_hp, od_price, payment_option, payment_check,delivery_status )
				  values('$user_no', '$order_name','$order_email','$order_hp','$order_price',$payment_option,'未入金','配送準備中')";
	...
	public function getOrderMain($od_no)
	{

		$query = "select a.od_no, a.od_price, b.receiver_address ,DATE_FORMAT(a.od_date, '%Y-%m-%d') as od_date 
